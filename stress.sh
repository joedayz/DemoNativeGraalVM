...
rm -f JDK_95.txt JDK_ALL_95.txt NI_95.txt NI_ALL_95.txt JLINK_95.txt JLINK_ALL_95.txt
touch JDK_95.txt JDK_ALL_95.txt NI_95.txt NI_ALL_95.txt JLINK_95.txt JLINK_ALL_95.txt

# Let's stress test and get some stats
echo -ne "Stress Testing..."
# Requests/sec: 

hey -z 15s -c 4 http://localhost:8081/teams | tee JDK_ALL_95.txt | grep --color=auto -Eo '95% in [0-9]+.[0-9]+ secs' > JDK_95.txt &
hey -z 15s -c 4 http://localhost:8083/teams | tee NI_ALL_95.txt | grep --color=auto -Eo '95% in [0-9]+.[0-9]+ secs' > NI_95.txt &
hey -z 15s -c 4 http://localhost:8082/teams | tee JLINK_ALL_95.txt | grep --color=auto -Eo '95% in [0-9]+.[0-9]+ secs' > JLINK_95.txt &
